...
//		System.out.println(mess);
		AssertJUnit.assertEquals(HomePage.getMessage1().contentEquals("ログイン名またはパスワードが違います。もう一度入力して下さい。"), true);
	}
